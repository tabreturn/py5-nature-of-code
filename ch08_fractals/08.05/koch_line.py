...
class KochLine:
    ...
    def __init__(self, a: Py5Vector2D, b: Py5Vector2D):
        ...
        # Parameters a and b are p5.Vector objects.
        self.start = a.copy
        self.end = b.copy
    ...
    def koch_points(self) -> list[Py5Vector2D]:
        ...
        b = a + v  # Add that vector to beginning of the line to find new point.
        ...
        return [a, b, c, d, e]  # Return all five points in a list.
